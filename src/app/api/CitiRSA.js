export function getByteArray(c) {
  var a = new Array();
...
function bnToString(j) {
  ...
  var f = (1 << h) - 1, c, b = false, e = "", g = this.t;
...
function bnpLShiftTo(c, g) {
  ...
  var b = this.DB - j;
  var e = (1 << b) - 1;
  var f = Math.floor(c / this.DB), d = (this.s << j) & this.DM, h;
...
function bnpSubTo(f, d) {
  var e = 0, c = 0, b = Math.min(f.t, this.t);
  while (e < b) {
    c += this[e] - f[e];
    d[e++] = c & this.DM;
    c >>= this.DB
...
function bnpDivRemTo(l, o, p) {
  ...
  var b = this.FV / k, c = (1 << this.F1) / k, d = 1 << this.F2;
  var g = p.t, h = g - j, q = (o == null) ? nbi() : o;
  r.dlShiftTo(h, q);
  if (p.compareTo(q) >= 0) {
    p[p.t++] = 1;
    p.subTo(q, p)
...
function bnpExp(d, c) {
  var e = nbi(), b = nbi(), f = c.convert(this), g = nbits(d) - 1;
  f.copyTo(e);
  while (--g >= 0) {
    c.sqrTo(e, b);
    if ((d & (1 << g)) > 0) {
...
function des(aj, s, n, r, ac, o) {
  ...
  var l = 0, ao, aq, am, ak, ag, ah, ae, al, m;
  var u, j, ai, aa;
  var q, k;
  var an = s.length;
  var t = 0;
